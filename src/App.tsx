...
function App() {
  return (
    <div className="min-h-screen flex flex-col items-center bg-gray-900 text-gray-100 p-4 pb-12">
      ...
      <div className="w-full max-w-4xl space-y-6">
        ...
        <div className="text-sm text-gray-400 p-4 bg-gray-800 rounded-lg shadow-sm border border-gray-700">
