  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900 text-gray-100">
      ...
      <footer role="contentinfo" className="w-full border-t border-gray-800 mt-8 sm:mt-12">
        <div className="w-full max-w-[90rem] mx-auto py-4 sm:py-6 px-3 sm:px-4 text-center text-xs sm:text-sm text-gray-500">
          <p>Made with accessibility in mind for all developers</p>
        </div>
      </footer>
    </div>
  )
